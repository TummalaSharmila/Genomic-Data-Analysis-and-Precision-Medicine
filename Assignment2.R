...
# Upregulated gene IDs
upregulated_gene_ids <- rownames(sig_mock_vs_SARS_df[sig_mock_vs_SARS_df$log2FoldChange > 0, ])

# Downregulated gene IDs
downregulated_gene_ids <- rownames(sig_mock_vs_SARS_df[sig_mock_vs_SARS_df$log2FoldChange < 0, ])

upregulated_gene_ids
downregulated_gene_ids

upregulated_gene_ids_24H_72H <- rownames(sig_24H_vs_72H_df[sig_24H_vs_72H_df$log2FoldChange > 0, ])
downregulated_gene_ids_24H_72H <- rownames(sig_24H_vs_72H_df[sig_24H_vs_72H_df$log2FoldChange < 0, ])
